...
@set "TEST_ROOT=%SCRIPT_ROOT%\MultipleTest"
...
@echo.
@echo --- scons:deps:beg ---
@"%PYEXE%" "%SCONS_ROOT%\scripts\scons.py" --site-dir="%SCONS_SITEDIR%" -Qn --scanner-deps %_SCONS_MSVC_COMPILER% --scanner=%_SCONS_SCANNER% --expected-map="{'main.c': ['include/include1.h', 'include/include2.h', 'include/include3.h', 'include/include4.h', 'include/include5.h']}"
@echo --- scons:deps:end ---
@echo.
