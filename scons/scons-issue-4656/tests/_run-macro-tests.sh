...
TEST_ROOT="${SCRIPT_ROOT}/MacroTest"
...
echo
echo --- scons:deps:beg ---
python "${SCONS_ROOT}/scripts/scons.py" --site-dir="${SCONS_SITEDIR}" -Qn --scanner-deps --scanner=${_SCONS_SCANNER} --expected-map="{'main.c': ['compiler_gcc.h', 'arch_x64.h']}"
echo --- scons:deps:end ---
echo
