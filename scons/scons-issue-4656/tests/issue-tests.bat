...
@call "%SCRIPT_ROOT%\_run-issue-tests.bat" CPreProcessorScanner
@echo ++++++ GCCProcessorScanner:end ++++++

@echo.
@echo ++++++ MSVCProcessorScanner:beg ++++++
@call "%SCRIPT_ROOT%\_run-issue-tests.bat" CPreProcessorScanner --msvc-compiler
@echo ++++++ MSVCProcessorScanner:end ++++++

@echo.
@echo ++++++ CConditionalScanner:beg ++++++
@call "%SCRIPT_ROOT%\_run-issue-tests.bat" CConditionalScanner
@echo ++++++ CConditionalScanner:end ++++++

@echo.
@echo ++++++ CScanner:beg ++++++
@call "%SCRIPT_ROOT%\_run-issue-tests.bat" CScanner
@echo ++++++ CScanner:end ++++++
