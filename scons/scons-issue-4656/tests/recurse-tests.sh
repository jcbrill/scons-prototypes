...
"${SCRIPT_ROOT}/_run-recurse-tests.sh" CPreProcessorScanner
echo ++++++ GCCProcessorScanner:end ++++++

echo
echo ++++++ CConditionalModScanner:beg ++++++
"${SCRIPT_ROOT}/_run-recurse-tests.sh" CConditionalModScanner
echo ++++++ CConditionalModScanner:end ++++++

echo
echo ++++++ CConditionalScanner:beg ++++++
"${SCRIPT_ROOT}/_run-recurse-tests.sh" CConditionalScanner
echo ++++++ CConditionalScanner:end ++++++

echo
echo ++++++ CScanner:beg ++++++
"${SCRIPT_ROOT}/_run-recurse-tests.sh" CScanner
echo ++++++ CScanner:end ++++++
