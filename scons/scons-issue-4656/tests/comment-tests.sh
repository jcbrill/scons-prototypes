...
"${SCRIPT_ROOT}/_run-comment-tests.sh" CPreProcessorScanner
echo ++++++ GCCProcessorScanner:end ++++++

echo
echo ++++++ CConditionalModScanner:beg ++++++
"${SCRIPT_ROOT}/_run-comment-tests.sh" CConditionalModScanner
echo ++++++ CConditionalModScanner:end ++++++

echo
echo ++++++ CConditionalScanner:beg ++++++
"${SCRIPT_ROOT}/_run-comment-tests.sh" CConditionalScanner
echo ++++++ CConditionalScanner:end ++++++

echo
echo ++++++ CScanner:beg ++++++
"${SCRIPT_ROOT}/_run-comment-tests.sh" CScanner
echo ++++++ CScanner:end ++++++
