...
@call "%SCRIPT_ROOT%\_run-known-tests.bat" CPreProcessorScanner
@echo ++++++ GCCProcessorScanner:end ++++++

@echo.
@echo ++++++ MSVCProcessorScanner:beg ++++++
@call "%SCRIPT_ROOT%\_run-known-tests.bat" CPreProcessorScanner --msvc-compiler
@echo ++++++ MSVCProcessorScanner:end ++++++

@echo.
@echo ++++++ CConditionalModScanner:beg ++++++
@call "%SCRIPT_ROOT%\_run-known-tests.bat" CConditionalModScanner
@echo ++++++ CConditionalModScanner:end ++++++

@echo.
@echo ++++++ CConditionalScanner:beg ++++++
@call "%SCRIPT_ROOT%\_run-known-tests.bat" CConditionalScanner
@echo ++++++ CConditionalScanner:end ++++++

@echo.
@echo ++++++ CScanner:beg ++++++
@call "%SCRIPT_ROOT%\_run-known-tests.bat" CScanner
@echo ++++++ CScanner:end ++++++
