...
echo
echo --- scons:deps:beg ---
python "${SCONS_ROOT}/scripts/scons.py" --site-dir="${SCONS_SITEDIR}" -Qn --scanner-deps --scanner=${_SCONS_SCANNER} --expected-map="{'main.c': ['../KnownIncl/include/dqfile1.h', 'include/dqfile2.h']}"
echo --- scons:deps:end ---
echo
