...
"${SCRIPT_ROOT}/_run-known-tests.sh" CPreProcessorScanner
echo ++++++ GCCProcessorScanner:end ++++++

echo
echo ++++++ CConditionalModScanner:beg ++++++
"${SCRIPT_ROOT}/_run-known-tests.sh" CConditionalModScanner
echo ++++++ CConditionalModScanner:end ++++++

echo
echo ++++++ CConditionalScanner:beg ++++++
"${SCRIPT_ROOT}/_run-known-tests.sh" CConditionalScanner
echo ++++++ CConditionalScanner:end ++++++

echo
echo ++++++ CScanner:beg ++++++
"${SCRIPT_ROOT}/_run-known-tests.sh" CScanner
echo ++++++ CScanner:end ++++++
