...
@set "TEST_ROOT=%SCRIPT_ROOT%\CommentTest"
...
@echo.
@echo --- scons:deps:beg ---
@"%PYEXE%" "%SCONS_ROOT%\scripts\scons.py" --site-dir="%SCONS_SITEDIR%" -Qn --scanner-deps %_SCONS_MSVC_COMPILER% --scanner=%_SCONS_SCANNER% --expected-map="{'main.c': ['active/comment3.h', 'active/comment4.h']}"
@echo --- scons:deps:end ---
@echo.
